...
export default async function HomePage() {
  ...
  return (
    <main>
      {/* ── Hero ── */}
      <section className="relative min-h-[92vh] flex items-center overflow-hidden" style={{backgroundColor: '#12100d'}}>
        {/* Ảnh nền */}
        ...
        <div
          ...
          style={{background: 'linear-gradient(135deg, rgba(18,16,13,0.92) 0%, rgba(18,16,13,0.25) 50%, rgba(18,16,13,0.82) 100%)'}}
        />

        {/* Đường kẻ trang trí góc trên trái */}
        <div className="absolute top-0 left-0 w-px h-40 bg-gradient-to-b from-[#c8922a99] to-transparent ml-12 hidden md:block" />
        <div className="absolute top-0 left-0 h-px w-40 bg-gradient-to-r from-[#c8922a99] to-transparent mt-12 hidden md:block" />

        <div className="relative w-full max-w-6xl mx-auto px-5 sm:px-6 py-20 sm:py-28">
          <div className="max-w-3xl">
            <FadeUp>
              <div className="flex items-center gap-3 mb-6 sm:mb-8">
                <div className="w-8 h-px" style={{backgroundColor: '#c8922a'}} />
                <p className="text-xs font-semibold uppercase tracking-[0.35em]" style={{color: '#c8922a'}}>
                  Specialty Coffee
                </p>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={100}>
              <h1 className="font-display text-5xl sm:text-6xl md:text-8xl font-light leading-[1.05] mb-6 sm:mb-8" style={{color: '#f7f0e6'}}>
                <ScrambleText
                  text="Mỗi tách"
                  delay={200}
                  speed={30}
                  ...
                  className="block"
                />
                <span className="block font-semibold italic" style={{color: '#c8922a'}}>
                  <ScrambleText
                    text="cà phê"
                    delay={500}
                    speed={30}
                ...
                <ScrambleText
                  ...
                  speed={30}
                  iterations={6}
                  className="block text-2xl sm:text-4xl md:text-5xl font-light mt-2 text-[rgba(247,240,230,0.65)]"
                />
              </h1>
            </FadeUp>

            <FadeUp delay={200}>
              <p className="text-sm sm:text-base max-w-md mb-8 sm:mb-12 leading-relaxed" style={{color: '#a89880'}}>
            ...
            <FadeUp delay={300}>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  ...
                  style={{backgroundColor: '#c8922a', color: '#12100d', boxShadow: '0 8px 24px rgba(200,146,42,0.25)'}}
                >
                  Xem Menu
                ...
                <Link
                  ...
                  style={{border: '1px solid rgba(247,240,230,0.2)', color: 'rgba(247,240,230,0.7)'}}
                >
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-10 right-12 hidden md:flex flex-col items-center gap-3" style={{color: 'rgba(168,152,128,0.5)'}}>
          <span className="text-[10px] tracking-[0.3em] uppercase rotate-90 origin-center mb-4">Scroll</span>
          <div className="w-px h-16" style={{background: 'linear-gradient(to bottom, rgba(200,146,42,0.5), transparent)'}} />
        </div>
      </section>

      {/* ── Marquee strip ── */}
      <div className="bg-brand-accent py-3 overflow-hidden" style={{backgroundColor: '#c8922a'}}>
